...
'ᴀɴ ᴀᴅᴠᴀɴᴄᴇᴅ ᴘʀᴇᴍɪᴜᴍ sᴜᴘᴇʀғᴀsᴛ ᴘᴏᴡᴇʀꜰᴜʟ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇʀ ᴡɪᴛʜ ᴀ ꜱᴜᴘᴇʀꜰᴀꜱᴛ ʜɪɢʜ Qᴜᴀʟɪᴛʏ ᴠᴄ ᴍᴜꜱɪᴄ ᴘʟᴀʏᴇʀ ꜰᴇᴀᴛᴜʀᴇ..!`
"""
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="💛ᴏᴡɴᴇʀ💛", url=f"http://t.me/Op_Aayush"),
        InlineKeyboardButton(
            text="🎶ᴍᴜsɪᴄ🎶", url=f"https://t.me/CreatorPavanSupport"
        ),
    ],
    [
        InlineKeyboardButton(text="💫ᴜᴘᴅᴀᴛᴇs💫", url=f"https://t.me/TheCreatorPavan"),
        InlineKeyboardButton(
            text="💕sᴜᴘᴘᴏʀᴛ💕", url=f"https://t.meCreatorPavanSupport"
        ),
    ],
    [
        InlineKeyboardButton(text="💝ᴀᴅᴅ ᴍᴇ ᴛᴏ ᴜʀ ᴄʜᴀᴛ💝", url="http://t.me/Aayuu_Robot?startgroup=true"),
    ],
]
...
def innexia_about_callback(update, context):
    ...
    if query.data == "innexia_":
        query.message.edit_text(
            text=""" 𝘼𝘼𝙔𝙐𝙐 - A bot to manage your groups with additional features!
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Bᴜɢ'ꜱ", url="https://t.me/TheCreatorPavan"
                        ),
                        InlineKeyboardButton(
                            text="Bᴏᴛ Lɪꜱᴛ", url="https://t.me/TheCreatorPavan/34"
                        ),
                    ],
        ...
        query.message.edit_text(
            ...
            f"\n• Than send `/admincache@Aayuu_Robot` in that chat to refresh admin list in My database.\n"
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Lᴏɢ'ꜱ", url="https://t.me/TheCreatorPavan"),
                    InlineKeyboardButton(text="Fᴇᴅ", url="https://t.me/TheCreatorPavan"),
                 ],
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="https://t.me/CreatorPavanSupport"),
                    InlineKeyboardButton(text="Uᴘᴅᴀᴛᴇꜱ", url="https://t.me/TheCreatorPavan"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="innexia_basichelp"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ᴀᴀʏᴜsʜ", url="t.me/Op_Aayush"),
                    InlineKeyboardButton(text="ᴘᴀᴠᴀɴ", url="t.me/Creator_Pavan"),
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..😻 I'm *ᴀᴀʏᴜᴜ*
                 \nHere is the [🔥 SUPPORT🔥](https://t.me/CreatorPavanSupport) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
